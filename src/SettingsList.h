...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::Toggle(StrId::STR_SLEEP_ROTATE_180, &CrossPointSettings::sleepScreenRotate180,
      ...
      SettingInfo::Toggle(StrId::STR_HYPHENATION, &CrossPointSettings::hyphenationEnabled, "hyphenationEnabled",
                          StrId::STR_CAT_READER),
      SettingInfo::Toggle(StrId::STR_SIMPLIFIED_TO_TRADITIONAL,
                          &CrossPointSettings::readerSimplifiedToTraditional, "readerSimplifiedToTraditional",
                          StrId::STR_CAT_READER),
      SettingInfo::Enum(StrId::STR_READER_TEXT_LAYOUT, &CrossPointSettings::readerTextLayout,
                        {StrId::STR_HORIZONTAL_LAYOUT, StrId::STR_VERTICAL_LAYOUT}, "readerTextLayout",
                        StrId::STR_CAT_READER),
